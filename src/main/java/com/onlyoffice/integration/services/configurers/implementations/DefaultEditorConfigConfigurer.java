...
public class DefaultEditorConfigConfigurer implements EditorConfigConfigurer<DefaultFileWrapper> {
        ...
        public void configure(final EditorConfig config,
                ...
                if (wrapper.getActionData() != null) { // check if the actionData is not empty in the editorConfig
                                                       // wrapper
                ...
                boolean userIsAnon = wrapper.getUser()
                                .getName().equals("Anonymous"); // check if the user from the editorConfig wrapper is
                                                                // anonymous or not
                ...
                config.setCallbackUrl(documentManager.getCallback(fileName)); // set the callback URL to the
                                                                              // editorConfig

                // set the document URL where it will be created to the editorConfig if the user
                // is not anonymous
