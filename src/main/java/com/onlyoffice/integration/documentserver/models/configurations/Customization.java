...
@Setter
/*
 * The parameters which allow to customize the editor interface so that it
 * looked like your
 * other products (if there are any) and change the presence or absence of the
 * additional buttons,
 * links, change logos and editor owner details.
 */
public class Customization {
  @Autowired
  private Goback goback; // the settings for the Open file location menu button and upper right corner
                         // button
  ...
  private Boolean compactHeader = false; /*
                                          ...
                                          * in the upper part of the editor window header next to the logo (false) or in
                                          * the toolbar (true)
                                          */
