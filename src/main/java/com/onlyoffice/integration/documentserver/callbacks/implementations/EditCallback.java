...
public class EditCallback implements Callback {
    ...
    public int handle(final Track body,
        ...
        if (action.getType().equals(com.onlyoffice.integration.documentserver.models.enums.Action.edit)) { // if this
                                                                                                           // value is
                                                                                                           // not equal
                                                                                                           // to the
                                                                                                           // user ID
            ...
            if (!body.getUsers().contains(user)) { // if this user is not specified in the body
                ...
                try {
                    // create a command request to forcibly save the document being edited without
                    // closing it
