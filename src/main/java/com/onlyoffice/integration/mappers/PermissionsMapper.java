...
@Component
@Primary
public class PermissionsMapper extends
                AbstractMapper<Permission, com.onlyoffice.integration.documentserver.models.filemodel.Permission> {
        @Autowired
        ...
        public void configure() { // configure the permission mapper
                mapper.createTypeMap(Permission.class,
                                com.onlyoffice.integration.documentserver.models.filemodel.Permission.class) // create
                                                                                                             // the type
                                                                                                             // map
        ...
        void handleSpecificFields(final Permission source,
                        final com.onlyoffice.integration.documentserver.models.filemodel.Permission destination) { // handle
                                                                                                                   // specific
                                                                                                                   // permission
                                                                                                                   // fields
                ...
                destination.setCommentGroups(
                                new CommentGroup(
                                                source.getCommentsViewGroups().stream().map(g -> g.getName())
                                                                .collect(Collectors.toList()),
                                                source.getCommentsEditGroups().stream().map(g -> g.getName())
                                                                .collect(Collectors.toList()),
                                                source.getCommentsRemoveGroups().stream().map(g -> g.getName())
                                                                .collect(Collectors.toList())));
